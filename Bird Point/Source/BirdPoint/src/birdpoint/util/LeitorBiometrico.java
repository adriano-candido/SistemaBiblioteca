...
public class LeitorBiometrico {
    ...
    public Aluno verificarSeCadastrado(String activeReader, List<Aluno> usuarios, JLabel tfImagem) {
            ...
            for (DPFPFingerIndex finger : DPFPFingerIndex.values()) {
                ...
                if (templateMaoDireita != null && templateMaoEsquerda != null) {
                    for (int i = 0; i < usuarios.size(); i++) {
                        try {
                            templateMaoDireita.deserialize(usuarios.get(i).getDigitalDireita());
                            templateMaoEsquerda.deserialize(usuarios.get(i).getDigitalEsquerda());
                            ...
                            if (resultMaoDireita.isVerified()) {
                                ...
                                System.out.printf("Esquerada OK",
        ...
        public Professor verificarSeCadastradoProf(String activeReader, List<Professor> usuarios, JLabel tfImagem) {
        DPFPTemplate templateMaoDireita = DPFPGlobal.getTemplateFactory().createTemplate();
        DPFPTemplate templateMaoEsquerda = DPFPGlobal.getTemplateFactory().createTemplate();
        try {
            DPFPSample sample = getSample(activeReader, "Scan your finger\n");
